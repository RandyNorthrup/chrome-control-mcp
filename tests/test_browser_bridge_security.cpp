...
void BrowserBridgeSecurityTests::pipeName_isScopedNoncedAndUnique() {
    ...
    QVERIFY(a.startsWith(QStringLiteral("\\\\.\\pipe\\ChromeControlMCP_BrowserBridge_")));
...
void BrowserBridgeSecurityTests::rendezvous_roundTripsAllFields() {
    ...
    const RendezvousRecord in{QStringLiteral("\\\\.\\pipe\\ChromeControlMCP_BrowserBridge_x"),
