        ...
        {QStringLiteral("browser_screenshot"),
         {QStringLiteral("screenshot"),
          ...
          {{QStringLiteral("full_page"), QStringLiteral("bool"), false},
           {QStringLiteral("include_control_overlay"), QStringLiteral("bool"), false}}}},
...
void appendNavTools(QJsonArray& tools) {
    ...
    tools.append(toolEntry(
        QStringLiteral("browser_screenshot"),
        QStringLiteral("Capture a PNG screenshot of the active tab (viewport by default). The "
...
void appendPrintTool(QJsonArray& tools) {
    tools.append(toolEntry(
        ...
        QStringLiteral(
            ...
            "to the user's Downloads/ChromeControlMCP folder; returns the saved path. Options: "
